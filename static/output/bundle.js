...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./static/js/main.js */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../css/main.less */ 4);
	
	var editor = __webpack_require__(/*! ./lib/editor/editor */ 3);
	var render = __webpack_require__(/*! ./render */ 2);
	var numBenchmarkLoops = 2000;
	
	window.onresize = function () {
	  render.resize();
	};
	
	var defaultText = "node(\n  { padding: 50, flexDirection: 'column' },\n   node({ padding: 10 }),\n   node({ padding: 10, marginTop: 10 }),\n   node({ padding: 10, marginTop: 10 }),\n   node({ padding: 10, alignSelf: 'center' }),\n   node({ padding: 10, alignSelf: 'flexEnd' })\n)";
	
	if (window.location.hash) {
	  defaultText = unescape(unescape(window.location.hash.slice(1)));
	}
	
	var mirror = editor.CodeMirror(document.getElementById("editor"), {
	  value: defaultText,
	  theme: "zenburn",
	  autofocus: true,
	  mode: "javascript"
	...
	benchmark.addEventListener("click", function () {
	  var timeTaken = render.benchmark(mirror.getValue(), numBenchmarkLoops);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _computeLayout = __webpack_require__(/*! ./lib/Layout */ 6);
	...
	function node(style) {
	  ...
	  var children = _toArray(_arguments).slice(1);
	...
	function renderNode(n) {
	  ...
	  ctx.fillRect(n.layout.left, n.layout.top, n.layout.width, n.layout.height);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./codemirror-4.8/lib/codemirror.css */ 11);
	__webpack_require__(/*! ./zenburn.css */ 8);
	__webpack_require__(/*! ./javascript.js */ 10);
	
	module.exports = {
	  CodeMirror: __webpack_require__(/*! ./codemirror-4.8/lib/codemirror */ 13)
	};
...
/* 10 */
/*!********************************************!*\
  !*** ./static/js/lib/editor/javascript.js ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var CodeMirror = __webpack_require__(/*! ./codemirror-4.8/lib/codemirror.js */ 13);
...
/* 11 */
/*!****************************************************************!*\
  !*** ./static/js/lib/editor/codemirror-4.8/lib/codemirror.css ***!
  \****************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 13 */
/*!***************************************************************!*\
  !*** ./static/js/lib/editor/codemirror-4.8/lib/codemirror.js ***!
  \***************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	(function (mod) {
	  ...
	  function updateScrollbars(cm, measure) {
	    ...
	    if (needsH && measure.scrollWidth <= measure.clientWidth + 1 && sWidth > 0 && !measure.hScrollbarTakesSpace) needsH = false; // (Issue #2562)
	  ...
	  function visibleLines(display, doc, viewport) {
	    ...
	    if (viewport && viewport.ensure) {
	      ...
	      if (ensureFrom < from) return { from: ensureFrom,
	        to: lineAtHeight(doc, heightAtLine(getLine(doc, ensureFrom)) + display.wrapper.clientHeight) };
	      if (Math.min(ensureTo, doc.lastLine()) >= to) return { from: lineAtHeight(doc, heightAtLine(getLine(doc, ensureTo)) - display.wrapper.clientHeight),
	        to: ensureTo };
	    }
	  ...
	  function postUpdateDisplay(cm, update) {
	    ...
	    for (var first = true;; first = false) {
	      if (first && cm.options.lineWrapping && update.oldScrollerWidth != cm.display.scroller.clientWidth) {
	        ...
	        if (viewport && viewport.top != null) viewport = { top: Math.min(cm.doc.height + paddingVert(cm.display) - scrollerCutOff - cm.display.scroller.clientHeight, viewport.top) };
	  ...
	  function endOperation_finish(op) {
	    ...
	    if (op.updatedDisplay && webkit) {
	      ...
	      if (op.barMeasure.scrollWidth > op.barMeasure.clientWidth && op.barMeasure.scrollWidth < op.barMeasure.clientWidth + 1 && !hScrollbarTakesSpace(cm)) updateScrollbars(cm); // (Issue #2562)
	    }
